...
if [ "${PV##*.}" = "9999" ]; then
	...
	SRC_URI="mirror://emacs/${P}.tar.bz2
		mirror://emacs/${P}-patches-5.tar.bz2"
...
SLOT="23"
KEYWORDS="alpha amd64 arm hppa ia64 ppc ppc64 s390 sh sparc x86-host ~sparc-fbsd ~x86-fbsd"
...
RDEPEND="${RDEPEND}
	>=app-emacs/emacs-common-gentoo-1"
...
src_configure() {
	...
	# rob: disable checking for long file names to avoid sandbox violation
	ac_cv_sys_long_file_names=yes econf \
